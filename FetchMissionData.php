...
if (id <> '') {
    ...
    $mission_query = $mysqli->query("SELECT * FROM missions_table WHERE owner_id='$id' ORDER BY time_complete DESC") or die($mysqli->error());

    $mission_array = array();
    while($mission = $mission_query->fetch_assoc()) {
