...
if(isset($_POST['id'])){
    ...
    $query1 = mysql_query("SELECT id FROM cleared_buildings WHERE id='$id' AND bldg_id ='$bldg_id' AND active=0")or die(mysql_error());
    ...
    if(mysql_num_rows($query1) > 0) {
        ...
        $query2 = mysql_query("SELECT id FROM cleared_buildings WHERE id='$id' AND bldg_id ='$bldg_id' AND active=1")or die(mysql_error());
